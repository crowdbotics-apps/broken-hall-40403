"""
Django settings for broken_hall_40403 project.
...
ROOT_URLCONF = 'broken_hall_40403.urls'
...
WSGI_APPLICATION = 'broken_hall_40403.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_hall_40403 API",
    "DESCRIPTION": "API documentation for broken_hall_40403 App",
    "VERSION": "v1",
}
